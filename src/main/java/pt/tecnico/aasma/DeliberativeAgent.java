...
//                    break;
//                
//                case "FriendCarryingFlagBelief":
//                    newDesires.add(new GoToBase(ourBase, true, 6));
//                    break;
//                
//                case "OurFlagDroppedBelief":
       ...
       executingPlan = true;
        ...
        switch (intention.getName()) {
             case "KillEnemy":
                ...
                System.out.println("P a NULLLLLLLLLLLLLLLLLLLLLLLLLLLLL");
                break;
