 ...
 * @author Miguel
 */
public class BraveDeliberativeAgent extends UT2004BotModuleController<UT2004Bot> {
    ...
    // Last known health pack location
...
//            else 
                return new Intention(d.getName(), d.getLocation());
    }
